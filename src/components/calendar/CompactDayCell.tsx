...
export const CompactDayCell = ({
  ...
  return (
    <div
      ...
      className={cn(
        'border-r border-b border-border hover:bg-accent/30 hover:shadow-sm transition-all duration-200 cursor-pointer min-h-0 h-full flex flex-col overflow-hidden',
        denseMode ? 'p-0.5' : 'p-1',
